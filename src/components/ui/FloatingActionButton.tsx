...
export default function FloatingActionButton({
  ...
  const shareActions = [
    ...
    },
    {
      ...
      action: () =>
        window.open(
          "https://pump.fun/coin/7z7rjKhwZh7TkCPSpiJqC95AVFaMkbLAkKBbYiJQpump",
          "_blank"
        ),
    },
    {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {/* Pulsing ring effect */}
      <motion.div
        className="absolute inset-0 rounded-full border-2 border-neon-blue/50 pointer-events-none"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.5, 0, 0.5],
        }}
